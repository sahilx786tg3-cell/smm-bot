...
TONCENTER_API_KEY = "7a05aa0f4a268950b75da3ad986b3ac40bb55429cab30080ae6bef771561e484"
...
def extract_ton_comment(in_msg: dict) -> str:
    """Extract memo/comment from TonCenter v3 in_msg object.
    v3 stores comment under message_content.decoded.comment"""
    if not in_msg:
        return ""
    # TonCenter v3 — primary location
    ...
    # fallback 1: decoded_body (some v3 responses)
    decoded_body = in_msg.get("decoded_body") or {}
    if decoded_body.get("comment"):
        return decoded_body["comment"].strip()
    # fallback 2: plain message field (v2 style)
